...
import { PageWithAdsLayout } from "@/components/layout/PageWithAdsLayout";
import { env } from "@/env";
...
export default async function StatisticsPage() {
  ...
  return (
    <PageWithAdsLayout>
      <div className="container mx-auto px-2 sm:px-4 pt-32 pb-8 max-w-5xl">
        {/* Propaganda do Google AdSense no topo */}
        {env.NEXT_PUBLIC_TOP_STEPPER_STEP_1_BANNER_AD_SLOT && (
        ...
        {/* Main Content - Protected by Authentication */}
        <AuthGuard>
          <ExercisesBrowser />
        </AuthGuard>
      </div>
