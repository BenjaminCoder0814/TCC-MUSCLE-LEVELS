...
# Acerca de muscle-levels

## ¿Por qué muscle-levels?

muscle-levels nació del deseo de ofrecer una plataforma de entrenamiento confiable, moderna y activamente mantenida, después de que el proyecto original <WorkoutLol variant="muted" /> fuera abandonado.

## La historia

muscle-levels es el resultado de una aventura impulsada por la comunidad.
...
muscle-levels es de open source, garantizando transparencia, modularidad y escalabilidad.
...
**[hello@muscle-levels](mailto:hello@muscle-levels)**
