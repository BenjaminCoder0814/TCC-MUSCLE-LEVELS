...
# À propos de muscle-levels

## Pourquoi muscle-levels ?

muscle-levels est né de la volonté de proposer une plateforme d'entraînement fiable, moderne et maintenue, après l'abandon du projet <WorkoutLol variant="muted" />.

## L'histoire

muscle-levels est le fruit d'une aventure communautaire.
...
muscle-levels est open source, garantir transparence, modularité et évolutivité.  
