export default {
  leaderboard: {
    ...
    last_workout: "上次锻炼",
    page_title: "冠军排行榜",
    page_subtitle: "登上顶峰，成为 Muscle Levels 传奇",
  ...
  premium: {
    ...
    already_premium: "您正在享受 Muscle Levels Premium",
    no_ads: "无广告",
    upgrade: "升级",
    ...
    plans: {
      ...
      free: {
        ...
        badge: "开源 • 始终免费",
        description: "所有基本功能",
        features: ["生成带有视频的练习", " 风格的训练历史（6 个月）", "分享和重复训练（即将推出）", "自托管可能", "代码源可用"],
        button: "您的实际计划",
    ...
    faq: {
      title: "常见问题",
      subtitle: "关于 Muscle Levels 和我们的使命",
      items: [
        {
          question: "为什么开源还要付费？",
          answer:
        ...
        {
          question: "我可以自托管 Muscle Levels 吗？",
          answer:
            "当然可以！整个代码库在 MIT 许可证下可在  上获得。您可以在自己的服务器上部署它，根据需要进行定制，并完全免费使用。自托管为您提供对数据和锻炼隐私的完全控制。",
        },
        {
          question: "我的锻炼数据安全吗？",
          answer:
        ...
        },
        {
          question: "进展跟踪如何工作？",
          answer:
            "每个组、重复、重量和时间都会自动记录。您会得到一个  风格的锻炼历史，显示您的连贯性，以及详细的分析，包括体积、进展和个人记录。高级用户会得到高级图表和见解。",
        },
        {
      ...
      additional_support: {
        ...
        community: "社区支持（Discord 或 hello@Muscle Levels）",
        discussions: "开放讨论（/discord）",
        roadmap: "透明路线图（）",
      },
    },
    ...
    free_intro_text:
      "Muscle Levels 是一个免费、开源的健身应用，每天有 60,000+ 用户使用。它是由爱（不是 VC 资金 ^^）构建的，并且为我们保持运行需要真实的时间和金钱。",
    donation_story_text:
      "起初，我们依靠捐赠运行。但正如您所想，捐赠不足以支付开发和运行成本。所以我们为您制作了一个包，将帮助我们保持灯光，并在路上解锁一些超级能力。",
    health_upgrade_text: "如果 Muscle Levels 帮助您提升健康，请考虑升级到高级：D ！",
    ...
    still_unsure: "还不确定？没关系。Muscle Levels 将始终保持免费和开源。",
  ...
  release_notes: {
    ...
    notes: {
      ...
      note_2025_06_23: {
        title: "🇵🇹 葡萄牙语支持和捐赠横幅",
        content:
          "应用现已支持<strong>葡萄牙语</strong>！我们还添加了<em>捐赠横幅</em>以帮助通过<a href='https://.com/sponsors/' target='_blank' rel='noopener' class='text-blue-500 hover:underline'> Sponsors</a>或<a href='https://nossa plataforma de apoio.com/workoutcool' target='_blank' rel='noopener' class='text-blue-500 hover:underline'>nossa plataforma de apoio</a>支持项目的持续成本。🙏",
      },
      note_2025_06_22: {
        title: "🌍 新语言支持和性能提升！",
      ...
      note_2025_06_19: {
        title: "📱 现已作为 PWA 提供！",
        content: "Muscle Levels v1.2 现在是一个渐进式网络应用！将其安装在您的手机上，即可享受原生应用体验和离线访问。🚀",
      },
      note_2025_06_18: {
        title:
        ...
        content: "Muscle Levels 在 Hacker News 上登顶！感谢大家的大力支持，欢迎所有新用户！💪",
      },
      note_2025_06_01: {
        title: "🎉 新功能：版本说明对话框",
  ...
  donation_alert: {
    title: "使用 Muscle Levels Premium 解锁高级功能",
    or: "或",
  },
  ...
  commons: {
    ...
    loading: "加载中...",
    image_deleted: "图片已删除",
    discover_workoutcool: "发现 Muscle Levels",
