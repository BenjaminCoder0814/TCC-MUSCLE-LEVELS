export default {
  leaderboard: {
    ...
    page_subtitle: "Sube a la cima y conviértete en una leyenda de Muscle Levels",
  ...
  premium: {
    ...
    already_premium: "Estás disfrutando de Muscle Levels Premium",
    no_ads: "Sin anuncios",
    upgrade: "Actualizar",
    ...
    plans: {
      ...
      free: {
        ...
        features: [
          ...
          "Historial de entrenamientos tipo  (6 meses)",
    ...
    faq: {
      ...
      subtitle: "Todo lo que necesitas saber sobre Muscle Levels y nuestra misión",
      items: [
        {
        ...
        {
          question: "¿Puedo auto-alojar Muscle Levels?",
          answer:
            "¡Absolutamente! Todo el código está disponible en  bajo licencia MIT. Puedes desplegarlo en tus propios servidores, personalizarlo como quieras y usarlo completamente gratis. El auto-alojamiento te da control total sobre tus datos y privacidad del entrenamiento.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Cada serie, repetición, peso y tiempo se registra automáticamente. Obtienes un historial de entrenamientos estilo  que muestra tu consistencia, además de análisis detallados sobre volumen, progresión y récords personales. Los usuarios Premium obtienen gráficos avanzados e insights.",
        },
        {
      ...
      additional_support: {
        ...
        community: "Community support (discord or hello@Muscle Levels)",
        discussions: "Open discussions (/discord)",
        roadmap: "Transparent roadmap ()",
      },
    },
    ...
    final_cta: {
      ...
      quote: {
        ...
        author: "— El equipo de Muscle Levels",
      },
    },
    ...
    free_intro_text:
      "Muscle Levels es una aplicación de fitness gratuita y de código abierto utilizada diariamente por más de 60,000 usuarios. Está construida con amor (no con dinero de VC ^^) y nos cuesta tiempo y dinero real mantenerla funcionando.",
    donation_story_text:
      "Al principio, funcionábamos con donaciones. Pero como puedes imaginar, las donaciones no fueron suficientes para cubrir los costos de desarrollo y funcionamiento. Así que creamos un paquete que nos ayudará a mantener las luces encendidas y desbloquear algunos superpoderes en el camino.",
    health_upgrade_text: "Si Muscle Levels te ayuda a mejorar tu salud, por favor considera pasarte a Premium :D !",
    ...
    still_unsure: "¿Todavía no estás seguro? No te preocupes. Muscle Levels siempre seguirá siendo gratuito y de código abierto.",
  ...
  release_notes: {
    ...
    notes: {
      ...
      note_2025_06_23: {
        ...
        content:
          "¡La app ahora soporta <strong>portugués</strong>! También hemos añadido un <em>banner de donación</em> para ayudar a cubrir los costos del proyecto via <a href='https://.com/sponsors/' target='_blank' rel='noopener' class='text-blue-500 hover:underline'> Sponsors</a> o <a href='https://nossa plataforma de apoio.com/workoutcool' target='_blank' rel='noopener' class='text-blue-500 hover:underline'>nossa plataforma de apoio</a>. 🙏",
      },
      note_2025_06_22: {
      ...
      note_2025_06_19: {
        ...
        content:
          "¡Muscle Levels v1.2 ahora es una Progressive Web App! Instálala en tu teléfono para una experiencia de aplicación nativa con acceso sin conexión. 🚀",
      },
      note_2025_06_18: {
        title:
        ...
        content:
          "¡Muscle Levels alcanzó el primer lugar en Hacker News! ¡Gracias a todos por el increíble apoyo y bienvenidos a todos los nuevos usuarios! 💪",
      },
      note_2025_06_01: {
  ...
  donation_alert: {
    title: "Desbloquea funciones avanzadas con Muscle Levels Premium",
    or: "o",
  },
