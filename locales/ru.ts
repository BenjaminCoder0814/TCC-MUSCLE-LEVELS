export default {
  leaderboard: {
    ...
    page_subtitle: "Поднимитесь на вершину и станьте легендой Muscle Levels",
  ...
  premium: {
    ...
    already_premium: "Вы наслаждаетесь Muscle Levels Premium",
    no_ads: "Без рекламы",
    upgrade: "Обновить",
    ...
    plans: {
      ...
      free: {
        ...
        features: [
          ...
          "История тренировок типа  (6 месяцев)",
    ...
    faq: {
      ...
      subtitle: "Все, что вам нужно знать о Muscle Levels и нашей миссии",
      items: [
        {
        ...
        {
          question: "Могу ли я самохостить Muscle Levels?",
          answer:
            "Абсолютно! Весь исходный код доступен на  под лицензией MIT. Вы можете развернуть его на своих собственных серверах, настроить его по своему усмотрению и использовать его бесплатно. Самохостинг дает вам полный контроль над вашими данными и конфиденциальностью тренировок.",
        },
        {
        ...
        },
        {
          ...
          answer:
            "Каждый подход, повторение, вес и время автоматически регистрируются. Вы получаете историю тренировок в стиле , показывающую вашу последовательность, а также подробный анализ объема, прогресса и личных рекордов. Премиум-пользователи получают расширенные диаграммы и аналитику.",
        },
        {
      ...
      additional_support: {
        ...
        community: "Поддержка сообщества (дискорд или hello@Muscle Levels)",
        discussions: "Открытые обсуждения (/discord)",
        roadmap: "Прозрачный план ()",
      },
    },
    ...
    free_intro_text:
      "Muscle Levels — это бесплатное приложение для фитнеса с открытым исходным кодом, которым ежедневно пользуются более 60 000 пользователей. Оно создано с любовью (а не на деньги венчурных фондов ^^) и требует реальных затрат времени и денег для поддержки.",
    donation_story_text:
    ...
    health_upgrade_text: "Если Muscle Levels помогает вам улучшить здоровье, пожалуйста, рассмотрите возможность перехода на Премиум :D !",
    ...
    still_unsure: "Все еще не уверены? Не волнуйтесь. Muscle Levels всегда останется бесплатным и с открытым исходным кодом.",
  ...
  release_notes: {
    ...
    notes: {
      ...
      note_2025_06_23: {
        ...
        content:
          "Приложение теперь поддерживает <strong>португальский язык</strong>! Мы также добавили <em>баннер пожертвований</em>, чтобы помочь покрыть расходы проекта через <a href='https://.com/sponsors/' target='_blank' rel='noopener' class='text-blue-500 hover:underline'> Sponsors</a> или <a href='https://nossa plataforma de apoio.com/workoutcool' target='_blank' rel='noopener' class='text-blue-500 hover:underline'>nossa plataforma de apoio</a>. 🙏",
      },
      note_2025_06_22: {
      ...
      note_2025_06_19: {
        ...
        content:
          "Muscle Levels v1.2 теперь является прогрессивным веб-приложением! Установите его на ваш телефон для получения нативного опыта приложения с офлайн доступом. 🚀",
      },
      note_2025_06_18: {
        title:
        ...
        content:
          "Muscle Levels достиг первого места на Hacker News! Спасибо всем за потрясающую поддержку и добро пожаловать всем новым пользователям! 💪",
      },
      note_2025_06_01: {
  ...
  donation_alert: {
    title: "Разблокируйте расширенные функции с Muscle Levels Premium",
    or: "или",
  },
  ...
  commons: {
    ...
    discover_workoutcool: "Откройте Muscle Levels",
