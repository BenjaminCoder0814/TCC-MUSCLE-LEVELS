...
export function PricingTestimonials() {
  ...
  const testimonials: Testimonial[] = [
    {
      quote:
        "I gained 15kg on bench press in 3 months with Muscle Levels's detailed tracking. The -style history kept me motivated to stay consistent.",
      author: "Marcus T.",
      role: "Powerlifter",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Join thousands of fitness enthusiasts who&apos;ve transformed their training with Muscle Levels
          </p>
